<?php
   ...
   */
?>
<div class="margin-bottom--xl padding-y--xxl <?php print $bg_color; ?>">
  <?php if ($title_anchor): ?>
    <a name="<?php print $title_anchor; ?>"></a>
  <?php endif; ?>
  <div class="container">
    <div class="display--flex flex-direction--row flex-wrap--wrap align-items--center">
      <div class="width--100 md--width--40 padding-x--md sm--padding--xl order--1">
        <?php if (!empty($title)): ?>
      ...
      <div class="width--100 md--width--60 order--0 md--order--4 text-align--center md--text-align--left padding-y--md md--padding-x--md">
        <?php print $image; ?>
      </div>
    </div>
  </div>
