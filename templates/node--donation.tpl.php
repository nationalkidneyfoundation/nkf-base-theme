...
<?php
  ...
  // field_donation_how_we_help
  // field_hero_image_background
  // field_hero_video_background
  // field_hero_image
  // field_donation_tag_line
  // field_donation_url
  // body
  // field_donation_type
  // title
  // field_donation_tweet?
  //
  // OTHER STUFF
  // social area
  //
    ...
    <div class="grid width--100  <?php print isset($content['field_hero_image_background']) ? '' : 'text-align--center';?>">
      ...
      <div class="grid-cell sm--width--70 md--width--50 width--100">
        <div class="donation__container">
          <div class="donation__header padding-y--md color--black  bg--gray-3 text-align--center">
